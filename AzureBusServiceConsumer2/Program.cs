...
using AzureBusServiceConsumer2;
public class Program
{
    static async Task Main(string[] args)
    {
        ...
        processor = client.CreateProcessor("onboardingtask", "subscriber2", new ServiceBusProcessorOptions());
        ...
        processor.ProcessMessageAsync += async args =>
        {
            ...
            producedMessage.ConsumerName = "subscriber2";
